    ...
    <div>
      ...
      <section className="row mb-5">
        ...
        <div className="col-lg-6 pt-5 ps-5">
          ...
          <img className="img-fluid mt-5 pt-5 ps-5"src="https://st3.depositphotos.com/1526816/12931/v/950/depositphotos_129316534-stock-illustration-many-kids-playing-different-musical.jpg" alt="" />
        </div>
